...
class Model:
    ...
    def parse_output(self, result):
        ...
        # Store some parameters in "stderr" (e.g., run-time) as attributes to
        #   the DataFrame.
        pass
    ...
    def run(self, parallel=False):
        ...
        # FIXME Parse `stderr` for other diagnostic data.
        return df
